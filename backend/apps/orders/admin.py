...
class OrderAdmin(admin.ModelAdmin):
    ...
    search_fields = ('id', 'user__email', 'user__username', 'address__phone')

    
    list_editable = ('status',)

    readonly_fields = ('subtotal', 'total', 'created_at', 'updated_at', 'address_detail')
    list_per_page = 25
    ...
    fieldsets = (
        ('📋 Order Info', {
            'fields': ('user', 'status', 'notes', 'created_at', 'updated_at')
        }),
        ('📍 Delivery Address', {
    ...
    def address_detail(self, obj):
        ...
        return "—"
    address_detail.short_description = "Address Details"