...
class PaymentAdmin(admin.ModelAdmin):
    ...
    def order_link(self, obj):
        return format_html('<a href="/admin/orders/order/{}/change/"><strong>অর্ডার #{}</strong></a>', obj.order.id, obj.order.id)
    ...
    provider_badge.short_description = "পেমেন্ট মাধ্যম"
    ...
    def status_badge(self, obj):
        ...
        labels = {
            ...
            'pending': '⏳ অপেক্ষমাণ', 'initiated': '🔄 শুরু হয়েছে',
            'cancelled': '🚫 বাতিল', 'refunded': '↩️ ফেরত',
        }
        return format_html(
